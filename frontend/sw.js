...
const ASSETS = [
    ...
    '/js/services/rhythm-progress.js',
    '/js/theory/notes.js',
    '/js/theory/fretboard.js',
    '/js/theory/tunings.js',
    '/js/theory/scales.js',
    '/js/theory/intervals-data.js',
    '/js/theory/curriculum.js',
    '/js/theory/ear-curriculum.js',
    '/js/theory/rhythm-patterns.js',
    ...
    '/js/modes/find-all-notes/index.js',
    '/js/modes/chord-practice/index.js',
    '/js/modes/scale-sequence/index.js',
    '/js/modes/degree-finder/index.js',
    '/js/modes/ear-training/index.js',
    '/js/modes/melody-memory/index.js',
    '/js/modes/rhythm-lab/index.js',
    '/js/modes/piano/index.js',
